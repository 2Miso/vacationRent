    ...
    <section class="d-flex">
      ...
      <div class="d-flex" style="height:100vh;" >
        ...
        <ul class="nav nav-pills flex-column mb-auto">
          ...
          <li>
            <a href="/vaca/user/mypage/pwchange" class="nav-link  active"><!--객실 관리 페이지로 링크 걸어야 합니다-->
          ...
          <li>
            <a href="/vaca/user/mypage/account" class="nav-link text-white" aria-current="page"><!--예약자 관리 페이지로 링크 걸어야 합니다-->
