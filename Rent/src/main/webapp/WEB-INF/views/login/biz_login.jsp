...
<section>
  <div class="login_form"><!--수직수평정렬용-->
    ...
    <div class="mx-auto py-3">
      ...
      <p class="my-0 text-center  "><a href="#" class="my-0 link-secondary link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover">비즈니스 회원가입</a></p><!--회원가입 링크를 걸어야 합니다-->
    </div>
  </div>
</section>
</body>
